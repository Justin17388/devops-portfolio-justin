// launch template for phonebook app
...
// application load balancer for phonebook app
...
// aws database instance for phonebook app
...
// route53 record for phonebook app
